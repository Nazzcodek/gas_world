...
urlpatterns = [
    ...
    path('pumps/product/<uuid:product_id>', PumpViewSet.as_view({'get': 'by_product'}), name='pump-by-pump'),
    path('pumps/pit/<uuid:pump_pit_id>/', PumpViewSet.as_view({'get': 'by_pump_pit'}), name='pump-by-pump-pit'),
    ...
    path('pumpreadings/station/<uuid:station_id>', PumpReadingViewSet.as_view({'get': 'by_station'}), name='pumpreadings-by-station'),
    path('pumpreadings/pump/<uuid:pump_id>', PumpReadingViewSet.as_view({'get': 'by_pump'}), name='pumpreadings-by-pump'),
    path('pumpreadings/attendant/<uuid:attendant_id>', PumpReadingViewSet.as_view({'get': 'by_attendant'}), name='pumpreadings-by-attendant'),
